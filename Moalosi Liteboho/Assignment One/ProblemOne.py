def main():
    while True:
        ...
        operating_sign = input("Enter the operating sign: ")  # Accepting the operating sign that will determine what calculation to be done
        ...
        if is_calculated:  # The if-statement that checks if the variable is_calculated is True and if yes print the Results
